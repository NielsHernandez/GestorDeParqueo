...
<div class="w3-row w3-section">
  <div class="w3-col" style="width:50px"></div>
    <div class="w3-rest">
      <input class="w3-input w3-border" name="id_empleado" type="text" placeholder="codigo de empleado">
    </div>
</div>
  ...
  <div class="w3-col" style="width:50px"></div>
    <div class="w3-rest">
      <select class="w3-select w3-border" name="puesto">
    <option value="" disabled selected>Selecionar puesto</option>
    <option value="Asistente Seguridad">Asistente Seguridad</option>
    <option value="Asistente Mantenimiento">Asistente Mantenimiento</option>
    <option value="Asistente Limpieza">Asistente Limpieza</option>
  ...
  <div class="w3-col" style="width:50px"></div>
    <div class="w3-rest">
      <select class="w3-select w3-border" name="jefe">
    <option value="" disabled selected>Selecionar jefe</option>
    <option value="Eduardo Buke">Eduardo Buke</option>
    <option value="Maria Ruano">Maria Ruano</option>
  </select>
    </div>
</div>
...
<div class="w3-row w3-section">
  <div class="w3-col" style="width:50px"></div>
    <div class="w3-rest">
      <input class="w3-input w3-border" name="salario" type="text" placeholder="salario Q">
    </div>
</div>
