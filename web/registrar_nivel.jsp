...
<div class="w3-main" style="margin-left:300px">
  ...
  <div class="w3-row-padding">
      <!-- formulario agregar vehiculo -->
              <form action="" class="w3-container  w3-light-grey w3-text-green w3-margin">
<h2 class="w3-center">Registro Nivel</h2>
 
<div class="w3-row w3-section">
  <div class="w3-col" style="width:50px"></div>
    <div class="w3-rest">
      <input class="w3-input w3-border" name="id_nivel" type="text" placeholder="id del nivel">
    </div>
</div>
...
<div class="w3-row w3-section">
  <div class="w3-col" style="width:50px"></div>
    <div class="w3-rest">
      <select class="w3-select w3-border" name="tarifa">
    <option value="" disabled selected>Selecionar tarifa Q</option>
...
<div class="w3-row w3-section">
  <div class="w3-col" style="width:50px"></div>
    <div class="w3-rest">
      <input class="w3-input w3-border" name="nombre_nivel" type="text" placeholder="nombre nivel ejemplo: A">
    </div>
</div>
...
<div class="w3-row w3-section">
  <div class="w3-col" style="width:50px"></div>
    <div class="w3-rest">
      <input class="w3-input w3-border" name="capacidad" type="text" placeholder="capacidad:">
    </div>
</div>
